...
package body Windows.Devices.Custom is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_ICustomDevice_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
