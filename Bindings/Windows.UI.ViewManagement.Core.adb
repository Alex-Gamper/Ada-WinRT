...
package body Windows.UI.ViewManagement.Core is
   ...
   function QueryInterface(This : access TypedEventHandler_ICoreInputView_add_OcclusionsChanged_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
