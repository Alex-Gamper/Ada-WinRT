...
package body Windows.ApplicationModel.Store.Preview.InstallControl is
   ...
   function CreateAppInstallManager return Windows.ApplicationModel.Store.Preview.InstallControl.IAppInstallManager is
      ...
      RetVal        : aliased Windows.ApplicationModel.Store.Preview.InstallControl.IAppInstallManager := null;
   begin
      Hr := RoActivateInstance(m_hString, Instance'Address);
      if Hr = 0 then
         Hr := Instance.QueryInterface(Windows.ApplicationModel.Store.Preview.InstallControl.IID_IAppInstallManager'Access, RetVal'Address);
