...
package Windows.Media.SpeechSynthesis is
   ...
   function QueryInterface(This :  access AsyncOperationCompletedHandler_ISpeechSynthesisStream_Interface ; riid : in Windows.GUID_Ptr ; pvObject : access IUnknown_Base) return Windows.HRESULT;
