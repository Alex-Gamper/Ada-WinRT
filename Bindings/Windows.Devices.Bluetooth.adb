...
package body Windows.Devices.Bluetooth is
   ...
   function CreateBluetoothSignalStrengthFilter return Windows.Devices.Bluetooth.IBluetoothSignalStrengthFilter is
      ...
      function Convert is new Ada.Unchecked_Conversion(IUnknown , Windows.Devices.Bluetooth.IBluetoothSignalStrengthFilter) with inline;
   begin
      Hr := RoActivateInstance(m_hString, Instance'Address);
      if Hr = 0 then
         Hr := Instance.QueryInterface(Windows.Devices.Bluetooth.IID_IBluetoothSignalStrengthFilter'Access, RetVal'access);
