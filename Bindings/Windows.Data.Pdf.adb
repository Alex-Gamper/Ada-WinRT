...
package body Windows.Data.Pdf is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_IPdfDocument_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
