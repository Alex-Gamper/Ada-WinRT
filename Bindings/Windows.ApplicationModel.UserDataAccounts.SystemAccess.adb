...
package body Windows.ApplicationModel.UserDataAccounts.SystemAccess is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_IDeviceAccountConfiguration_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
