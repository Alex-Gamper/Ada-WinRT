...
package body Windows.UI.Core.Preview is
   ...
   function QueryInterface(This : access EventHandler_ISystemNavigationCloseRequestedPreviewEventArgs_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
