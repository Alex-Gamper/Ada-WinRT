...
package Windows.ApplicationModel.VoiceCommands is
   ...
   function Create return Windows.ApplicationModel.VoiceCommands.IVoiceCommandContentTile;
   
   subtype VoiceCommandUserMessage is Windows.ApplicationModel.VoiceCommands.IVoiceCommandUserMessage;
   function Create return Windows.ApplicationModel.VoiceCommands.IVoiceCommandUserMessage;
