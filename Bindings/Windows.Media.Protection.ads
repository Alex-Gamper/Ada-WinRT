...
package Windows.Media.Protection is
   ...
   function Create return Windows.Media.Protection.IMediaProtectionManager;
   ...
   function Create return Windows.Media.Protection.IProtectionCapabilities;
   
   subtype HdcpSession is Windows.Media.Protection.IHdcpSession;
   function Create return Windows.Media.Protection.IHdcpSession;
