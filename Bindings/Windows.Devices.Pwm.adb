...
package body Windows.Devices.Pwm is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_IPwmController_Interface; riid : in Windows.GUID_Ptr ; pvObject : access IUnknown_Base) return Windows.HRESULT is
