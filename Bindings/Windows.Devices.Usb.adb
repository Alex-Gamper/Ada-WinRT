...
package body Windows.Devices.Usb is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_IUsbDevice_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
   ...
   function QueryInterface(This : access TypedEventHandler_IUsbInterruptInPipe_add_DataReceived_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
      Hr : Windows.HResult := E_NOTIMPL;
      m_IUnknown : aliased Windows.IUnknown_Base;
      RefCount   : Windows.UInt32;
      pragma suppress(Accessibility_Check);
