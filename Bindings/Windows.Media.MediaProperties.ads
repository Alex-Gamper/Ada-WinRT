...
package Windows.Media.MediaProperties is
   ...
   function QueryInterface(This :  access AsyncOperationCompletedHandler_IMediaEncodingProfile_Interface ; riid : in Windows.GUID_Ptr ; pvObject : access IUnknown_Base) return Windows.HRESULT;
