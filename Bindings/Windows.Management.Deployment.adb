...
package body Windows.Management.Deployment is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_IPackageVolume_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
