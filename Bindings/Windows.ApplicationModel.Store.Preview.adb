...
package body Windows.ApplicationModel.Store.Preview is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_IStorePreviewPurchaseResults_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
      Hr : Windows.HResult := E_NOTIMPL;
      m_IUnknown : aliased Windows.IUnknown_Base;
      RefCount   : Windows.UInt32;
      pragma suppress(Accessibility_Check);
   begin
      if riid.all = IID_AsyncOperationCompletedHandler_IStorePreviewPurchaseResults or riid.all = IID_IUnknown then
