...
package body Windows.ApplicationModel.Store.Preview is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_IStorePreviewPurchaseResults_Interface; riid : in Windows.GUID_Ptr ; pvObject : access IUnknown_Base) return Windows.HRESULT is
