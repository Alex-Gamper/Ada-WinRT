...
package body Windows.Security.ExchangeActiveSyncProvisioning is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_IEasComplianceResults_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
