...
package Windows.UI.Xaml.Hosting is
   ...
   function QueryInterface(This :  access TypedEventHandler_IDesignerAppManager_add_DesignerAppExited_Interface ; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT;
   ...
   function QueryInterface(This :  access AsyncOperationCompletedHandler_IDesignerAppView_Interface ; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT;
