...
package body Windows.Foundation.Collections is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_IPropertySet_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
