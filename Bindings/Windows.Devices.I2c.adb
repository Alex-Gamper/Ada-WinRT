...
package body Windows.Devices.I2c is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_II2cDevice_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_II2cController_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
      Hr : Windows.HResult := E_NOTIMPL;
      m_IUnknown : aliased Windows.IUnknown_Base;
      RefCount   : Windows.UInt32;
      pragma suppress(Accessibility_Check);
