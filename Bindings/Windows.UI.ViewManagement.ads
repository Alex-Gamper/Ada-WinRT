...
package Windows.UI.ViewManagement is
   ...
   function Create return Windows.UI.ViewManagement.IApplicationViewTransferContext;
   ...
   function Create return Windows.UI.ViewManagement.IAccessibilitySettings;
