...
package body Windows.Security.Authentication.OnlineId is
   ...
   function QueryInterface(This : access AsyncOperationCompletedHandler_IOnlineIdSystemTicketResult_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
