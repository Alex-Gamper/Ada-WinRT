...
package body Windows.Storage.AccessCache is
   ...
   function QueryInterface(This : access TypedEventHandler_IStorageItemMostRecentlyUsedList_add_ItemRemoved_Interface; riid : in Windows.GUID_Ptr ; pvObject : not null access IUnknown_Base) return Windows.HRESULT is
