...
package body Windows.UI.Xaml.Media.Animation is
   ...
   function QueryInterface(This : access TypedEventHandler_IConnectedAnimation_add_Completed_Interface; riid : in Windows.GUID_Ptr ; pvObject : access IUnknown_Base) return Windows.HRESULT is
