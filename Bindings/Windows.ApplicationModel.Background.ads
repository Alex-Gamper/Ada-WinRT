...
package Windows.ApplicationModel.Background is
   ...
   function Create return Windows.ApplicationModel.Background.ICommunicationBlockingAppSetAsActiveTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.IApplicationTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.IContentPrefetchTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.ISecondaryAuthenticationFactorAuthenticationTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.ICachedFileUpdaterTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.IAppointmentStoreNotificationTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.IBackgroundTaskBuilder;
   
   subtype ChatMessageNotificationTrigger is Windows.ApplicationModel.Background.IChatMessageNotificationTrigger;
   function Create return Windows.ApplicationModel.Background.IChatMessageNotificationTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.IChatMessageReceivedNotificationTrigger;
   
   subtype RcsEndUserMessageAvailableTrigger is Windows.ApplicationModel.Background.IRcsEndUserMessageAvailableTrigger;
   function Create return Windows.ApplicationModel.Background.IRcsEndUserMessageAvailableTrigger;
   
   subtype ContactStoreNotificationTrigger is Windows.ApplicationModel.Background.IContactStoreNotificationTrigger;
   function Create return Windows.ApplicationModel.Background.IContactStoreNotificationTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.IDeviceServicingTrigger;
   
   subtype RfcommConnectionTrigger is Windows.ApplicationModel.Background.IRfcommConnectionTrigger;
   function Create return Windows.ApplicationModel.Background.IRfcommConnectionTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.IBluetoothLEAdvertisementWatcherTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.IBluetoothLEAdvertisementPublisherTrigger;
   ...
   function Create return Windows.ApplicationModel.Background.IGeovisitTrigger;
